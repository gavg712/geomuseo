                  ...
                  div(class = "col-sm-12 col-md-12 col-lg-12",
                      div(class = "row gallery-item",
                          div(class = "col-md-4",
                              ...
                              a(href = "img/jobs/Paredes_Quilumba-2017.pdf", target = "_blank",
                                "Descargar póster")
                          ),
                          div(class = "col-md-4",
                              ...
                              a(href = "img/jobs/Cargua_Guaman-2018.pdf", target = "_blank",
                                "Descargar póster")
                          ),
                          div(class = "col-md-4",
                              a(href = "img/jobs/Guaman_Paredes-2018.jpg",
                                title = "La influencia de la Geología en la vida",
                                `data-lightbox-gallery` = "gallery1",
                                `data-lightbox-hidpi` = "img/jobs/1@2x.png",
                                img(src = "img/jobs/Guaman_Paredes-2018.jpg",
                                    class = "img-responsive",
                                    alt = "img")
                              ),
                              a(href = "img/jobs/Guaman_Paredes-2018.pdf", 
                                target = "_blank", "Descargar póster")
                          )
                      )
                  )
              )
