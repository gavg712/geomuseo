fluidPage(
  ...
  tags$body(`data-spy`="scroll",
            ...
            tags$section( id="intro", class="intro", 
                          div(class="slogan",
                              ...
                              p(strong("Un proyecto de estudiantes de la carrera de Ingeniería en Geociencias de la Universidad Regional Amazónica Ikiam"))
                          ),
                          div(class="row", align="center",
                              a(href="#about", class="btn btn-skin scroll", "Leer más...")
                          )
            ),
            tags$section(id="about", 
                                 ...
                                 div(class="row",
                                                 ...
                                                 div(class="col-md-9",
                                                     tags$ul(
                                                       tags$li("Stalin Guamán",
                                                               a(href="https://www.researchgate.net/profile/Stalin_Guaman", "Perfil")),
                                                       tags$li("Gabriel Gaona", 
                                                               a(href="https://www.researchgate.net/profile/Gabriel_Gaona","Perfil")))
                                                 )
                                             )
                                         ),
                                         div(class="row", align="left",
                                     ...
                                     div(class="col-lg-8",
                                         ...
                                         div(class="section-heading", align="left",
                                             p(class="text-justify", "Aquí va más información sobre el proyecto")
                                         )
                                     )
                                 )
                             )
                         ...
                         div(class="row",
                             a(href="#service",
                               class="btn btn-skin scroll","más...")
                         )
            ),
            tags$section(id="service", class="home-section text-center",
                         div(class="heading-about marginbot-50",
                             div(class="container",
                                 div(class="row",
                                     div(class="col-lg-8 col-lg-offset-2",
                                         div(class="section-heading",
                                             h2("Servicios"),
                                             p("Sistemas de información geográfica y análisis espacial de información meteorológica")
                                         )
                                     )
                                 )
                             )
                                 ...
                                 div(class="col-sm-3 col-md-3",
                                     div(class="service-box",
                                         ...
                                         div(class="service-desc",
                                             h5("Cartografía"),
                                             p("Estudios y levantamiento de cartografía temática en el área de las ciencias del medio ambiente.")
                                         )
                                     )
                                 ),
                                 div(class="col-sm-3 col-md-3",
                                     div(class="service-box",
                                         ...
                                         div(class="service-desc",
                                             ...
                                             p("Investigación y cálculos espaciales mediante modelos numéricos de variables ambientales.")
                                         )
                                     )
                                 ),
                                 div(class="col-sm-3 col-md-3",
                                     div(class="service-box",
                                         div(class="service-icon",
                                             ...
                                             div(class="service-desc",
                                                 h5("IDE's"),
                                                 p("Desarrollo e Implementación de infraestructuras de datos espaciales.")
                                             )
                                         )
                                     )
                                 ),
                                 div(class="col-sm-3 col-md-3",
                                     div(class="service-box",
                                         ...
                                         div(class="service-desc",
                                             ...
                                             p("Diseño de planes de educación ambiental e interpretación del paisaje.")
                                         )
                                     )
                                 )
                             )
            ...
            tags$section(id="works", 
                         ...
                         div(class="container",
                                     ...
                                     div(class="row gallery-item",
                                         ...
                                         div(class="col-md-3",
                                             a(href="img/works/2.png", 
                                               ...
                                               `data-lightbox-gallery`="gallery1",
                                               `data-lightbox-hidpi`="img/works/1@2x.png",
                                               img(src="img/works/2.png", class="img-responsive", alt="img")
                                             )
                                         ),
                                         div(class="col-md-3",
                             ...
                             div(class="row",
                                 a(href="#contact", class="btn btn-skin scroll", "más...")
                             )
                         )
            )
  ),
  tags$section(id="contact",
                           ...
                           div(class="boxed-grey",
                               div(class="boxed-grey",
                                   div(class="widget-contact row",
                                       div(class="col-lg-6",
                                           tags$address(
                                             strong("Universidad Regional Amazónica Ikiam"),
                                             br(),
                                             "Km 7 1/2 vía a Muyuna",
                                             br(),
                                             "Tena, EC190505",
                                             tags$abbr(title="Teléfono","F:"), br(),
                                             "(+593) XXX-XXX-XXXX"
                                           )
                                       ),
                                       div(class="col-lg-6",
  ...
  tags$footer(
    div(class="container",
        div(class="row",
            div(class="col-md-6">
                  p("Volver al ", a(href="#intro", class="btn btn-skin scroll", "Principio") 
                  ),
                div(class="col-md-6">
                      p("Ir al ", a(href="http://gavg712.com", class="btn btn-skin scroll", "Blog"))
                )
            )	
        )
    ),
